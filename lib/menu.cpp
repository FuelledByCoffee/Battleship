...
/*
A list of most if not all of the curses functions used in this program,
...
void Menu::StartGame(std::string gameType) {
	if (gameType == "normal") {
		...
		// std::cout << RED << gameType << " is an invalid gametype" << RESET <<
		// std::endl;
	}
}
...
void Menu::titleScreen() { // prints a fancy title screen :)
	...
	mvprintw(3, 2,
	         ...
	         "88                           ");
	mvprintw(4, 2,
	         "88,dPPYba,  ,adPPYYba, MM88MMM MM88MMM 88  ,adPPYba, ,adPPYba, "
	         "88,dPPYba,  88  8b,dPPYba,   ");
	mvprintw(
			5, 2,
			R"(88P'    '8a ""     `Y8   88      88    88 a8P_____88 I8[    "" 88P'    "8a 88  88P'    "8a  )");
	mvprintw(
			6, 2,
			R"(88       d8 ,adPPPPP88   88      88    88 8PP"""""""  `"Y8ba,  88       88 88  88       d8  )");
	mvprintw(
			7, 2,
			R"(88b,   ,a8" 88,    ,88   88,     88,   88 "8b,   ,aa aa    ]8I 88       88 88  88b,   ,a8"  )");
	mvprintw(
			8, 2,
			R"(8Y"Ybbd8"'  `"8bbdP"Y8   "Y888   "Y888 88  `"Ybbd8"' `"YbbdP"' 88       88 88  88`YbbdP"'   )");
	mvprintw(9, 2,
	         "                                                                 "
	         "              88           ");
	mvprintw(10, 2,
...
void Menu::endScreen() {                      // end credits basically
	init_pair(21, COLOR_YELLOW, COLOR_BLACK); // sets the colours that I want to
	                                          // use
	init_pair(22, COLOR_GREEN, COLOR_BLACK);
	init_pair(23, COLOR_RED, COLOR_BLACK);
	init_pair(24, COLOR_CYAN, COLOR_BLACK);

	mvprintw(getmaxy(stdscr) / 2.5, getmaxx(stdscr) / 3,
	         "Thank you for playing battleship");
	mvprintw(getmaxy(stdscr) / 2.5 + 1, getmaxx(stdscr) / 3,
	         "Have a good day :)");
...
//     mvprintw(4 , 2,   "88,dPPYba,  ,adPPYYba, MM88MMM MM88MMM 88  ,adPPYba,
//     ,adPPYba, 88,dPPYba,  88  8b,dPPYba,   "); mvprintw(5 , 2, R"(88P'    '8a
//     ""     `Y8   88      88    88 a8P_____88 I8[    "" 88P'    "8a 88  88P'
//     "8a  )"); mvprintw(6 , 2, R"(88       d8 ,adPPPPP88   88      88    88
//     8PP"""""""  `"Y8ba,  88       88 88  88       d8  )"); mvprintw(7 , 2,
//     R"(88b,   ,a8" 88,    ,88   88,     88,   88 "8b,   ,aa aa    ]8I 88 88
//     88  88b,   ,a8"  )"); mvprintw(8 , 2, R"(8Y"Ybbd8"'  `"8bbdP"Y8   "Y888
//     "Y888 88  `"Ybbd8"' `"YbbdP"' 88       88 88  88`YbbdP"'   )");
//     mvprintw(9 , 2,   " 88           "); mvprintw(10, 2,   " 88           ");

//     mvprintw(12, 2,
//     "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~oo~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
//     mvprintw(13, 2,   "                                 o o "); mvprintw(14,
//     2,   "                                 o ooo "); mvprintw(15, 2,   " o oo
//     "); mvprintw(16, 2,   "                                      o o      |
//     #)      art by:        "); mvprintw(17, 2,   " oo     _|_|_#_    -Scott
//     Mason-    "); mvprintw(18, 2,   " o   | 751   |                    ");
//     mvprintw(19, 2,   "    __                    ___________________|
//     |_________________   "); mvprintw(20, 2, R"(   |   -_______-----------
//     \\ )"); mvprintw(21, 2,   "  >|    _____ --->     )"); mvprintw(22, 2, "
